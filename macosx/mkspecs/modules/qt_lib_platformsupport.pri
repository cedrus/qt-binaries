QT.platformsupport.VERSION = 5.1.1
QT.platformsupport.MAJOR_VERSION = 5
QT.platformsupport.MINOR_VERSION = 1
QT.platformsupport.PATCH_VERSION = 1
QT.platformsupport.name = QtPlatformSupport
QT.platformsupport.libs = $$QT_MODULE_LIB_BASE
QT.platformsupport.private_includes = $$QT_MODULE_INCLUDE_BASE $$QT_MODULE_INCLUDE_BASE/QtPlatformSupport $$QT_MODULE_INCLUDE_BASE/QtPlatformSupport/5.1.1 $$QT_MODULE_INCLUDE_BASE/QtPlatformSupport/5.1.1/QtPlatformSupport
...
QT.platformsupport.module_config = staticlib internal_module
