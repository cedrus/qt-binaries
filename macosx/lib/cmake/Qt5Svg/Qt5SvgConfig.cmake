...
set(Qt5Svg_VERSION_STRING 5.1.1)
...
if (NOT TARGET Qt5::Svg)
    ...
    set(Qt5Svg_PRIVATE_INCLUDE_DIRS
        "${_qt5Svg_install_prefix}/include/QtSvg/5.1.1"
        "${_qt5Svg_install_prefix}/include/QtSvg/5.1.1/QtSvg"
    )
    ...
    foreach(_module_dep ${_Qt5Svg_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.1.1 ${_Qt5Svg_FIND_VERSION_EXACT}
    ...
    _populate_Svg_target_properties(RELEASE "libQt5Svg.5.1.1.dylib" "" )



    _populate_Svg_target_properties(DEBUG "libQt5Svg_debug.5.1.1.dylib" "" )
